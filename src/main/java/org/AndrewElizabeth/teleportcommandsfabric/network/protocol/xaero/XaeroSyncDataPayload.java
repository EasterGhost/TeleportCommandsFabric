...
public record XaeroSyncDataPayload(XaeroSyncPayload payload) implements CustomPacketPayload {
	public static final Type<XaeroSyncDataPayload> TYPE = new Type<>(XaeroSyncPackets.SYNC_DATA_ID);
	public static final StreamCodec<FriendlyByteBuf, XaeroSyncDataPayload> CODEC = StreamCodec.of(
