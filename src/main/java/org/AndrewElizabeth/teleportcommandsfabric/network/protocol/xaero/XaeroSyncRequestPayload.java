...
public record XaeroSyncRequestPayload() implements CustomPacketPayload {
	public static final Type<XaeroSyncRequestPayload> TYPE = new Type<>(XaeroSyncPackets.SYNC_REQUEST_ID);
	public static final StreamCodec<FriendlyByteBuf, XaeroSyncRequestPayload> CODEC = StreamCodec.unit(new XaeroSyncRequestPayload());
