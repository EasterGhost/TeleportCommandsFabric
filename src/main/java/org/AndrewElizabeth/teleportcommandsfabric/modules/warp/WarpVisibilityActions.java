...
final class WarpVisibilityActions {
	...
	static void setPlayerVisibility(ServerPlayer player, String warpName, boolean visible) throws Exception {
		withPlayerData(player, playerData -> VisibilityCommandSupport.update(visible,
	...
	static void setGlobalVisibility(ServerPlayer player, String warpName, boolean visible) throws Exception {
		VisibilityCommandSupport.update(visible, () -> WarpCommandSupport.resolveWarpForCommand(warpName, player, false),
	...
	private static void updatePlayerWarpVisibility(PlayerData playerData, NamedLocation warp, boolean visible)
			throws Exception {
		if (visible) {
	...
	private interface WarpPlayerAction {
		void run(PlayerData playerData) throws Exception;
	}
}
