...
final class AdminNodeFactory {
	...
	private AdminNodeFactory() {
	}

	static LiteralArgumentBuilder<CommandSourceStack> buildRootNode(String literal) {
	...
	private static LiteralArgumentBuilder<CommandSourceStack> buildReloadNode() {
		return Commands.literal("reload")
				.requires(AdminNodeFactory::isOpOrConsole)
				.executes(AdminCommandHandler::reload);
	}

	private static LiteralArgumentBuilder<CommandSourceStack> buildDebugNode() {
		return Commands.literal("debug")
				.requires(AdminNodeFactory::isOpOrConsole)
				.executes(AdminCommandHandler::sendCurrentDebug)
				.then(Commands.literal("true")
						.executes(context -> AdminCommandHandler.setDebug(context, true)))
				.then(Commands.literal("false")
						.executes(context -> AdminCommandHandler.setDebug(context, false)));
	}

	private static LiteralArgumentBuilder<CommandSourceStack> buildStatusNode() {
		return Commands.literal("status")
				.requires(AdminNodeFactory::isOpOrConsole)
				.executes(context -> AdminCommandHandler.sendStatus(context.getSource()));
	}
