...
public final class LocationResolver {
	...
	public static Optional<NamedLocation> resolveHome(PlayerData playerStorage, String homeName) {
	...
	public static Optional<NamedLocation> resolveHome(PlayerData playerStorage, UUID uuid) {
