...
public final class VisibilityCommandSupport {
	...
	public static <T> void update(boolean visible, VisibilityResolver<T> resolver, VisibilityChecker<T> checker,
			VisibilityUpdater<T> updater, VisibilityHook onAlreadyVisible, VisibilityHook onChanged) throws Exception {
