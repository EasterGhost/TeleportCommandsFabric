...
| --------------- | -------------: | --------------------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.3             |              3 |                     1 | Map integration update. Keeps the v2.2 config/storage schema. Adds JourneyMap integration and preserves invalid-dimension home/warp entries during profile load.                    |
...
- Updated the standard build documentation to describe bundled Xaero and JourneyMap support, and clarified that the core build excludes bundled map integrations.
